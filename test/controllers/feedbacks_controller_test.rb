...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create feedback' do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { author: @feedback.author, body: @feedback.body } }
    end
  ...
  test 'should update feedback' do
    patch feedback_url(@feedback), params: { feedback: { author: @feedback.author, body: @feedback.body } }
